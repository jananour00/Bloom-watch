...
export async function fetchNDVIData(bbox, startDate, endDate) {
...
export async function fetchClimateData(bbox, startDate, endDate) {
...
export async function fetchBloomData(region, startDate, endDate) {
  try {
...
export function classifyBloomStage(ndvi, ndviSlope) {
...
export function calculateBloomIntensity(ndvi, evi) {
